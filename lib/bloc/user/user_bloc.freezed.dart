...
class __$$_GetDataCopyWithImpl<$Res>
    extends _$UserEventCopyWithImpl<$Res, _$_GetData>
...
abstract class _GetData implements UserEvent {
...
class _$_Success implements _Success {
  const _$_Success({final List<UserModel> users = const []}) : _users = users;
...
abstract class _Success implements UserState {
  const factory _Success({final List<UserModel> users}) = _$_Success;
